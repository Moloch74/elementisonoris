...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "index.chiSiamoIntro": { it: "ELEMENTI SONORI UNDERGROUND RECORDS SHOP", en: "ELEMENTI SONORI UNDERGROUND RECORDS SHOP" },
  "index.chiSiamoDesc1": { it: "Si propone come fucina d'arte e laboratorio sonoro e grafico, un luogo dove prendono forma idee, collaborazioni e iniziative varie. Un punto d'incontro per chi crea, sperimenta e porta avanti la ricerca artistica.", en: "A creative forge and sound-and-graphic workshop, a place where ideas, collaborations and initiatives take shape. A meeting point for those who create, experiment and carry forward artistic research." },
  "index.chiSiamoDesc2": { it: "\"Elementi Sonori\" nasce come spazio dedicato alla cultura artistica e musicale indipendente e alle sue radici più autentiche. Il negozio è un punto di riferimento per dj, per chi ama l'arte in tutte le sue forme, per appassionati di musica underground, e offre una selezione curata di vinili, insieme a produzioni autoprodotte e label emergenti a livello europeo.", en: "\"Elementi Sonori\" was born as a space dedicated to independent artistic and musical culture and its most authentic roots. The shop is a reference point for DJs, art lovers in all its forms and underground music enthusiasts, offering a curated selection of vinyl alongside self-produced works and emerging European labels." },
  "index.chiSiamoDesc3": { it: "L'obiettivo è preservare e diffondere la cultura del suono, che nasce dalla terra, dai capannoni e dai sound system, da sempre lontana dalle logiche commerciali. Oltre alla vendita, lo shop promuove eventi, listening sonori, incontri con artisti e label indipendenti, rappresentando un punto di connessione fra scena locale e internazionale.", en: "The goal is to preserve and spread sound culture — born from the land, the warehouses and the sound systems, far removed from commercial logic. Beyond retail, the shop hosts events, listening sessions and meetings with independent artists and labels, acting as a bridge between the local and international scene." },
  "index.chiSiamoTagline": { it: "NO TREND, JUST MUSIC!", en: "NO TREND, JUST MUSIC!" },
